...
Şirketiniz, macOS cihazınızın şirket kaynaklarına güvenle erişebildiğinden emin olmak için birkaç aracı birden kullanır. Cihazınızın bu kaynaklara erişebildiğinizden emin olmak için, **uygulamalar**  >  **self servis**' e gitmeniz ve cihazınızın şirket ilkeleriyle uyumlu olduğundan emin olmanız veya cihazınızda başka işlemler gerçekleştirdiğinizden emin olmanız gerekir.
...
Şirket Portalı uygulamasını açtıysanız ve "AccountNotOnboarded" gibi bir ileti görüntülenirse, Şirket portalı uygulamadan çıkmanız ve **uygulamalar**  >  **self servis**' e gitmeniz gerekir. Şirketinizin, yüklemeniz gereken bir cihaz kayıt ilkesi olacaktır. İlkeyi yüklemek için tıklayın ve ardından Şirket Portalı'nı yeniden açın.
