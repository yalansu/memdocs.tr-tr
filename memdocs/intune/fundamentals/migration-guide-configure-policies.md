...
Cihaz kaydından önce cihaz gruplarını yapılandırırsanız cihaz kategorilerini kullanabilir ve cihazların kayıttan sonra otomatik olarak gruplara katılmasını sağlayabilirsiniz. Daha sonra, grubun cihaz ilkelerini otomatik olarak alır. [Grupları kullanmaya başlama](groups-get-started.md).
...
- [İOS](../configuration/custom-settings-ios.md)için özel bir ilke eklemeyi öğrenin.
...
- [Uygulamaları dağıtma](../apps/apps-deploy.md).
