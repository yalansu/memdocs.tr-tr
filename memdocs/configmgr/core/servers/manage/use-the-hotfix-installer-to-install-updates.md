...
Microsoft 'tan aldığınız bir güncelleştirmeyi (veya düzeltmeyi) kurmanız gerektiğinde ve bu güncelleştirmenin dosya adı **. exe** ( **Update. exe**değil) ile bitiyorsa, güncelleştirmeyi doğrudan Configuration Manager site sunucusuna yüklemek için bu düzeltme indirmesinde bulunan düzeltme yükleyicisini kullanırsınız.  

Düzeltme dosyasında **. Update. exe** dosyası uzantısı varsa, [düzeltmeleri Configuration Manager almak Için güncelleştirme kayıt aracı 'nı kullanma](../../../core/servers/manage/use-the-update-registration-tool-to-import-hotfixes.md)bölümüne bakın.  
...
###  <a name="update-servers"></a><a name="bkmk_servers"></a> Sunucuları güncelleştirme  
