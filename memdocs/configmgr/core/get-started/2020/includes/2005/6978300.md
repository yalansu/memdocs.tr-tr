...
- [Add-Cmchoparlör Managementgatewayconnectionpoint](https://docs.microsoft.com/powershell/module/configurationmanager/Add-CMCloudManagementGatewayConnectionPoint?view=sccm-ps)
