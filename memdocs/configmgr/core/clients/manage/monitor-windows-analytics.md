---
title: Windows Analytics ile istemcileri izleme
titleSuffix: Configuration Manager
description: Windows Analytics, ortamınızın geçerli durumu hakkında değerli Öngörüler çizmenizi sağlayan bir çözüm kümesidir.
ms.date: 01/31/2020
