---
title: 1810 için tanılama ve kullanım verileri
titleSuffix: Configuration Manager
description: Configuration Manager sürüm 1810 ' deki her düzeyde toplanan belirli veriler hakkında bilgi edinin.
ms.date: 05/13/2019
...
Configuration Manager sürüm 1810 için, bu düzey aşağıdaki verileri içerir:
...
- ***[Güncelleştirilmiş]*** Temel veritabanı yapılandırması: işlemciler, bellek boyutu, bellek ayarları, Configuration Manager veritabanı yapılandırması, Configuration Manager veritabanı boyutu, küme yapılandırması, dağıtılmış görünümlerin yapılandırılması ve değişiklik izleme sürümü  
...
- ***[Güncelleştirilmiş]*** Dala, yapıya ve benzersiz Active Directory ormanına göre Windows 10 cihazlarının sayısı  
...
- ***[Güncelleştirilmiş]*** İstemcilerde ve sunucularda kullanılan ilk 10 işlemci adı  
...
- ***[Yeni]*** Bellek kullanımı ve kilit sayısı bazında popüler SQL sorgularının karma listesi  

- ***[Taşınmış, güncelleştirilmiş]*** Ortak yönetim 'in toplu kullanım istatistikleri: şimdiye kadar kaydolan istemci sayısı, kayıtlı istemci sayısı, kayıt bekleyen istemci sayısı, ilke, iş yükü durumları, pilot/dışlama koleksiyon boyutları ve kayıt hataları  
...
- ***[Yeni]*** E-posta onayı özelliğinin kullanımıyla ilgili toplu istatistikler  

- ***[Yeni]*** Uygulama kataloğunda dosya sayısı, içerik boyutu, hizmet sayısı ve Mssıs özel eylem sayısı  
...
- İstemci sürümüne göre istemci sistem durumu istatistikleri ve en önemli sorun Özeti  
...
- ***[Yeni]*** Kaydedilen CMPivot sorgularının sayısı  

- ***[Yeni]*** Varlık türüne göre sorgu sayısı  
...
- ***[Yeni]*** Yapılandırmaya göre sınır grupları sayısı  
...
- ***[Yeni]*** İçeri aktarılan makinelerin sayısı  
...
- ***[Yeni]*** Gerekli, dağıtılmış, süre dolma, yenisiyle değiştirilen ve indirilen toplu güncelleştirme sayısı hakkında toplanmış istatistikler  

- ***[Yeni]*** UUP ürün kategorilerinin kullanımı  

- ***[Yeni]*** En az bir adet dağıtılmış kalite güncelleştirmesi veya güncelleştirme özelliği olan istemcilerin sayısı  

- ***[Yeni]*** En yüksek hata kodları ve etkilenen cihaz sayısı  
...
- ***[Yeni]*** Yönetim noktası trafik istatistikleri (uç nokta tarafından gönderilen ve alınan toplam bayt)  

- ***[Yeni]*** Yönetim noktası performans sayacı ölçümleri  
...
- ***[Yeni]*** NTLM 'ye geri dönüşe izin verme seçeneği ile gönderilen istemci sayısı  
