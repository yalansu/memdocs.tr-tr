...
Hızlı yükleme dosyalarının doğası nedeniyle, içerik boyutları geleneksel kendi içindeki dosyalardan oldukça büyük. Bu boyut, Windows Update hizmetinden Configuration Manager site sunucusuna güncelleştirme indirme sürelerinin uzamasına neden olur. Hem site sunucusu hem de dağıtım noktaları için gereken disk alanı miktarı da artar. Kalite güncelleştirmelerinin indirilmesi ve dağıtılması için gereken toplam süre daha uzun olabilir. Ancak, Windows 10 cihazlar tarafından kalite güncelleştirmelerinin indirilmesi ve yüklenmesi sırasında cihaz tarafı avantajları dikkat edilmelidir. Daha fazla bilgi için bkz. [hızlı yükleme dosyalarını kullanma](https://docs.microsoft.com/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc708456(v=ws.10)?#using-express-installation-files).
...
Ağ bağlantı noktaları, proxy gereksinimleri ve güvenlik duvarları için ana bilgisayar adları hakkında daha fazla bilgi için bkz. [dağıtım iyileştirmesi Için SSS](https://docs.microsoft.com/windows/deployment/update/waas-delivery-optimization#frequently-asked-questions).
