---
title: 'Yazılım güncelleştirmelerini indirme '
titleSuffix: Configuration Manager
description: Yazılım güncelleştirmelerini indirmek ve istemcilere dağıtıma hazırlanmak için bunları dağıtım noktalarına dağıtmak için yazılım güncelleştirmelerini Indirme Sihirbazı 'Nı kullanın.
ms.date: 01/23/2017
ms.topic: conceptual
...
ms.locfileid: "81719088"
---
# <a name="download-software-updates"></a>Yazılım güncelleştirmelerini indirme  

*Uygulama hedefi: Configuration Manager (geçerli dal)*

Configuration Manager ' de yazılım güncelleştirmelerini indirirken kullanabileceğiniz çeşitli yöntemler vardır. Bir otomatik dağıtım kuralı (ADR) oluşturduğunuzda veya yazılım güncelleştirmelerini manuel olarak dağıtırsanız, yazılım güncelleştirmeleri site sunucusundaki içerik kitaplığına indirilir. Ardından, yazılım güncelleştirmeleri, yapılandırılmış dağıtım paketiyle ilişkili dağıtım noktalarında içerik kitaplığına kopyalanır. Yazılım güncelleştirmelerini dağıtmadan önce yüklemek istiyorsanız, Güncelleştirme Yükleme Sihirbazını kullanabilirsiniz. Bunun yapılması, yazılım güncelleştirmelerini istemci bilgisayarlara dağıtmadan önce dağıtım noktalarında mevcut yazılım güncelleştirmelerini doğrulamanızı sağlar.  

> [!NOTE]  
>  İçerik durumunu izleme hakkında bilgi için bkz. [İçerik durumunu izleme](../deploy-use/monitor-software-updates.md#BKMK_ContentStatus).  

Yazılım Güncelleştirmelerini Yükle Sihirbazını kullanarak yazılım güncelleştirmelerini yüklemek için aşağıdaki prosedürü kullanın.  

#### <a name="to-download-software-updates"></a>Yazılım güncelleştirmelerini yüklemek için  
